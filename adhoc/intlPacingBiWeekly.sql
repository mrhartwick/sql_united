...
WHERE (cast(Click_Time as date) BETWEEN ''2016-01-01'' AND ''2016-11-18'')
...
WHERE cast(impression_time as date) BETWEEN ''2016-01-01'' AND ''2016-11-18''
-- Intl 2016
and order_id in (
9923634,   	-- SFO-SIN
9973506,   	-- SFO-AKL
...
-- where almost.Site_ID ='1327576'
-- and almost.order_id = '9923634'
