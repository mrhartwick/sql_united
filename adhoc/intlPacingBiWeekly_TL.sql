...
WHERE (cast(Click_Time as date) BETWEEN ''2016-06-20'' AND ''2016-11-14'')
...
WHERE cast(impression_time as date) BETWEEN ''2016-06-20'' AND ''2016-11-14''
and order_id = 9973506 -- SFO-AKL
and site_id = 1327576
