...
-- // =================================================================================================================
drop table diap01.mec_us_united_20056.ual_overlap_tbl3
create table diap01.mec_us_united_20056.ual_overlap_tbl3
(
    user_id        varchar(50) not null,
    site_id_dcm    int         not null,
    impressiontime int         not null,
...
insert into diap01.mec_us_united_20056.ual_overlap_tbl3
(user_id,site_id_dcm,impressiontime,imp_nbr)
...
select count(distinct user_id) as users, count(distinct cvr_nbr) as conv from diap01.mec_us_united_20056.ual_overlap_prs_cnv
select count(distinct user_id) as users, count(distinct imp_nbr) as imps from diap01.mec_us_united_20056.ual_overlap_rtg
select count(distinct user_id) as users, count(distinct cvr_nbr) as conv from diap01.mec_us_united_20056.ual_overlap_rtg_cnv
select count(distinct user_id) as users, count(distinct imp_nbr) as imps from diap01.mec_us_united_20056.ual_overlap_tbl3
