...
create table diap01.mec_us_united_20056.ual_freq_slm_imp1
(
...
insert into diap01.mec_us_united_20056.ual_freq_slm_imp1
(user_id,event_time,cost)
...
insert into diap01.mec_us_united_20056.ual_freq_slm_tbl1
(user_id, conversiontime, impressiontime,
 imp_key,
 revenue, cost, cvr_nbr, imp_nbr)
...
--              dbm_auction_id,
             ...
             from
                 diap01.mec_us_united_20056.ual_freq_slm_imp1
...
create table diap01.mec_us_united_20056.ual_freq_slm_tbl2
(
    user_id    varchar(50) not null,
    cvr_nbr    int         not null,
...
insert into diap01.mec_us_united_20056.ual_freq_slm_tbl2
(user_id,cvr_nbr,cvr_credit)
    ...
    from
        diap01.mec_us_united_20056.ual_freq_slm_tbl1
    group by
        user_id,
        cvr_nbr);
commit;
...
create table diap01.mec_us_united_20056.ual_freq_slm_tbl3
(
    user_id        varchar(50) not null,
    conversiontime int         not null,
    impressiontime int         not null,
...
insert into diap01.mec_us_united_20056.ual_freq_slm_tbl3
(user_id,conversiontime,impressiontime,revenue,cost,cvr_nbr,imp_nbr,yr,wk,cvr_credit)
    ...
    (select
        ...
        b.cvr_credit
    from
        diap01.mec_us_united_20056.ual_freq_slm_tbl1 a,
        diap01.mec_us_united_20056.ual_freq_slm_tbl2 b
    where
        a.user_id = b.user_id and
            a.cvr_nbr = b.cvr_nbr
    );
...
--                 sum(cost) as cost
-- from
--                 diap01.mec_us_united_20056.ual_freq_slm_tbl3
-- group by
--                 yr,
--                 wk;
-- ====================================================================================================================

create table diap01.mec_us_united_20056.ual_freq_slm_tbl4
(
    user_id    varchar(50) not null,
    yr         int         not null,
    wk         int         not null,
...
-- drop table diap01.mec_us_united_20056.ual_freq_slm_tbl4

insert into diap01.mec_us_united_20056.ual_freq_slm_tbl4
...
-- ====================================================================================================================
-- ====================================================================================================================
create table diap01.mec_us_united_20056.ual_freq_slm_tbl5
(
    user_id    varchar(50) not null,
    yr         int         not null,
    wk         int         not null,
...
insert into diap01.mec_us_united_20056.ual_freq_slm_tbl5
(user_id,yr,wk,cvr_cnt,imp_cnt,cvr_credit,revenue,cost)
    ...
    (
        ...
        from (select
                  ...
                  sum(t0.cost)       as cost
              from
                  diap01.mec_us_united_20056.ual_freq_slm_tbl4 as t0
              group by
                  t0.user_id,
                  t0.yr,
                  t0.wk
              ...
              select
                  ...
                  sum(t1.cost)    as cost
              from
                  diap01.mec_us_united_20056.ual_freq_slm_imp3 as t1
              group by
                  t1.user_id,
                  t1.yr,
                  t1.wk
...
select
    ...
    sum(revenue)   as rev,
    sum(cost)      as cost
from diap01.mec_us_united_20056.ual_freq_slm_tbl5
