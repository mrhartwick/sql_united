...
--  sum(usr_tot)                                                                                           as usr_tot,
  ...
  sum((cast(usr_run as decimal(20,10)) / cast(usr_tot as decimal(20,10))) * cast(100 as decimal(20,10))) as usr_pct_run,

--  sum(imp)                                                                                               as imp,
--  sum((cast(imp as decimal(20,10)) / cast(imp_tot as decimal(20,10))) * cast(100 as decimal(20,10)))     as imp_pct,
  sum(imp_run)                                                                                           as imp_run,
  sum((cast(imp_run as decimal(20,10)) / cast(imp_tot as decimal(20,10))) * cast(100 as decimal(20,10))) as imp_pct_run,

--  sum(cst)                                                                                               as cst,
--  sum((cast(cst as decimal(20,10)) / cast(cst_tot as decimal(20,10))) * cast(100 as decimal(20,10)))     as cst_pct,
  sum(cst_run)                                                                                           as cst_run,
  sum((cast(cst_run as decimal(20,10)) / cast(cst_tot as decimal(20,10))) * cast(100 as decimal(20,10))) as cst_pct_run,

--  sum(con)                                                                                               as con,
--  sum((cast(con as decimal(20,10)) / cast(con_tot as decimal(20,10))) * cast(100 as decimal(20,10)))     as con_pct,
  sum(con_run)                                                                                           as con_run,
  sum((cast(con_run as decimal(20,10)) / cast(con_tot as decimal(20,10))) * cast(100 as decimal(20,10))) as con_pct_run,

--  sum(rev)                                                                                               as rev,
--  sum((cast(rev as decimal(20,10)) / cast(rev_tot as decimal(20,10))) * cast(100 as decimal(20,10)))     as rev_pct,
  sum(rev_run)                                                                                           as rev_run,
  sum((cast(rev_run as decimal(20,10)) / cast(rev_tot as decimal(20,10))) * cast(100 as decimal(20,10))) as rev_pct_run,
