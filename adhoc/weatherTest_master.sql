...
-- dcm placement id
  ...
  case
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_Test_%' then 'Test'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_Control_%' then 'Control'
  end                                                                                                as weather_cat,

  case
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_PAC_%' then 'Pacific'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_MTN_%' then 'Mountain'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_WNC_%' then 'West North Central'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_WSC_%' then 'West South Central'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_ENC_%' then 'East North Central'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_NEW_%' then 'New England'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_MID_%' then 'Mid Atlantic'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_SAT_%' then 'South Atlantic'
  when t3.campaign_id = 10742878 and t3.site_id_dcm = 1853562 and t3.placement like '%_Weather_%' and t3.placement like '%_ESC_%' then 'East South Central'
...
where cast (timestamp_trunc(to_timestamp(interaction_time / 1000000),''SS'') as date ) between ''2017-01-01'' and ''2017-12-30''
and not regexp_like(substring(other_data,(instr(other_data,''u3='') + 3),5),''mil.*'',''ib'')
and (activity_id = 978826 or activity_id = 1086066)
and campaign_id = 10742878  -- TMK 2017
...
where cast (timestamp_trunc(to_timestamp(event_time / 1000000),''SS'') as date ) between ''2017-01-01'' and ''2017-12-30''
and campaign_id = 10742878  -- TMK 2017
and site_id_dcm = 1853562 -- Amobee
...
')
    ...
    where t1.placement like '%_Weather_%'
