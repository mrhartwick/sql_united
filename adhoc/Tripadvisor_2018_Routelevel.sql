...
insert into  wmprodfeeds.united.ual_trip_route_1
(user_id,
con_date,
imp_date,
campaign_id,
    ...
    (select
      ...
      ,ta.rev
        ...
        (
            ...
            where md_interaction_date_loc between '2018-06-19' and '2018-07-31'
            and (activity_id = 978826 or activity_id = 1086066)
            and campaign_id = 21276874
            and (advertiser_id <> 0)
            ...
            from wmprodfeeds.united.dfa2_impression
             ...
             where md_event_date_loc between '2018-06-19' and '2018-07-31'
            and campaign_id = 21276874
            and (advertiser_id <> 0)
            ) as ti
...
-- openquery function call must not exceed 8,000 characters; no room for comments inside the function
        from (
                 ...
                 from openQuery(redshift,
                                ...
                                sum(tix)          as tix,
                                sum(rev) as rev
                                from wmprodfeeds.united.ual_trip_route_1 as t1
...
on t1.site_id_dcm = s1.site_id_dcm
                                ...
                                where t1.campaign_id = 21276874
                                and con_date between ''2018-06-19'' and ''2018-07-31''
...
--    Prisma data
          ...
          where t1.dcmdate between '2018-06-19' and '2018-07-31'
