...
cast(max(r1.rt_1_orig) as varchar(3)) as rt_1_orig,
cast(max(r1.rt_1_dest) as varchar(3)) as rt_1_dest,
cast(max(r1.rt_2_orig) as varchar(3)) as rt_2_orig,
cast(max(r1.rt_2_dest) as varchar(3)) as rt_2_dest,
sum(r1.impressions) as impressions,
sum(r1.clicks) as clicks,
sum(r1.clk_led) as clk_led,
sum(r1.vew_led) as vew_led,
sum(r1.clk_led) + sum(r1.vew_led) as led,
...
,sum(ta.total_revenue * 1000000 / rates.exchange_rate) as rev -- select *
from
(
select
*,
...
,cast(null as varchar) as rt_1_orig
,cast(null as varchar) as rt_1_dest
,cast(null as varchar) as rt_2_orig
,cast(null as varchar) as rt_2_dest
...
on r1.site_id_dcm = directory.site_id_dcm group by
