...
case when t5.tp_rank = 3 then t5.site_cat else 'zzz' end as path_1,
case when t5.tp_rank = 2 then t5.site_cat else 'zzz' end as path_2,
case when t5.tp_rank = 1 then t5.site_cat else 'zzz' end as path_3
--     t5.site_id,
