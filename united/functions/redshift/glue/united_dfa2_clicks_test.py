...
try:
	df = df1.withColumn("AcquiredTime", lit(currrent_time)).withColumn("md_event_time_loc", udf_cvt_to_es_ts(df1._c0).cast("timestamp")).withColumn("md_event_date", udf_cvt_to_na_dt(df1._c0)).withColumn("md_event_date_loc", udf_cvt_to_es_dt(df1._c0).cast("date"))
except:
...
try:
	datasource1 = datasource0.resolveChoice(
		specs=[('_c0', 'cast:long'),
			   ...
			   ('_c98', 'cast:long'),
			   ('_c99', 'cast:boolean'),
			   ('_c100', 'cast:timestamp'),
			   ('_c101', 'cast:timestamp'),
			   ('_c102', 'cast:int'),
...
applymapping1 = ApplyMapping.apply(frame=datasource1, mappings=[("_c0", "long", "event_time", "long"),
																...
																("_c73", "int", "dbm_cpm_fee_4_advertiser_currency", "int"),
																("_c74", "int", "dbm_cpm_fee_5_usd", "int"),
																("_c75", "int", "dbm_cpm_fee_5_partner_currency", "int"),
																("_c76", "int", "dbm_cpm_fee_5_advertiser_currency", "int"),
																("_c77", "int", "dbm_media_fee_1_usd", "int"),
																("_c78", "int", "dbm_media_fee_1_partner_currency","int"),
																("_c79", "int", "dbm_media_fee_1_advertiser_currency", "int"),
																("_c80", "int", "dbm_media_fee_2_usd", "int"),
