...
df = df1.withColumn("AcquiredTime", lit(currrentTime)).withColumn("md_interaction_time", udf_cvt_to_na_ts(df1._c19))
...
try:
	datasource1 = datasource0.resolveChoice(
		specs=[('_c0', 'cast:long'), ('_c1', 'cast:string'), ('_c2', 'cast:int'), ('_c3', 'cast:int'),
			   ...
			   ('_c58', 'cast:decimal(37,15)'), ('_c59', 'cast:int'), ('_c60', 'cast:int'),
