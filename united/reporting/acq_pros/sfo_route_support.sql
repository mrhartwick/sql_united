...
from
    (
        select
            ...
            when t1.rt_2_dest in ('ABQ','AUS','PEK','BOS','LAS','LHR','LAX','MEX','EWR','SNA','MCO','PSP','SAN','SEA','PVG','TPE','IAD') then t1.rt_2_dest
            when t1.rt_1_dest in ('ABQ','AUS','PEK','BOS','LAS','LHR','LAX','MEX','EWR','SNA','MCO','PSP','SAN','SEA','PVG','TPE','IAD') then t1.rt_1_dest
            else t1.rt_2_dest
            end                                                                                          as destination,
...
where
t2.route_1_origin LIKE '%SFO%'
AND (
  t2.destination like '%ABQ%'
  or t2.destination like '%AUS%'
  ...
  or t2.destination like '%EWR%'
  or t2.destination like '%SNA%'
  or t2.destination like '%MCO%'
  or t2.destination like '%PSP%'
  or t2.destination like '%SAN%'
  or t2.destination like '%SEA%'
  or t2.destination like '%PVG%'
  or t2.destination like '%TPE%'
