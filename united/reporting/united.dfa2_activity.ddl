create table united.dfa2_activity
(
	...
	md_interaction_time_loc timestamp,
	md_interaction_date date,
	md_interaction_date_loc date,
...
alter table united.dfa2_activity owner to wmredshiftuser;
