...
from
                ...
                where
                                ...
                                and cast(timestamp_trunc(to_timestamp(event_time / 1000000),'SS') as date) between '2017-02-14' and '2017-12-31'
                                and advertiser_id <> 0
                ) as a
...
--                                 and t2.campaign_id = 10742878 --gm acq
                                and t2.campaign_id = 10918234 --win ny
                                and t2.advertiser_id <> 0
...
and t1.user_id <> '0'
and t1.advertiser_id <> '0'
and cast(to_timestamp(t1.interaction_time / 1000000) as date) between '2017-01-01' and '2017-12-31'
