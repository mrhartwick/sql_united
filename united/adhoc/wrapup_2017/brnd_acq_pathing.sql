...
create table diap01.mec_us_united_20056.ual_pathing_brnd
(
...
insert into diap01.mec_us_united_20056.ual_pathing_brnd
(user_id,
--  campaign_id,
 brandtime)
...
create table diap01.mec_us_united_20056.ual_pathing_gacq
(
    user_id        varchar(50) not null,
--     campaign_id    int         not null,
...
insert into diap01.mec_us_united_20056.ual_pathing_gacq
(user_id,
--  campaign_id,
...
--                                 campaign_id,
                                brandtime
                from
                                diap01.mec_us_united_20056.ual_pathing_brnd
                ) as a,
...
--puchased a ticket
drop table diap01.mec_us_united_20056.ual_pathing_conv
create table diap01.mec_us_united_20056.ual_pathing_conv
(
    user_id        varchar(50) not null,
--     campaign_id    int         not null,
...
insert into diap01.mec_us_united_20056.ual_pathing_conv
(user_id,
--  campaign_id,
 conversiontime,
 rev,
...
--                                 row_number() over () as cvr_nbr
                ...
                where
                    ...
                    and (user_id in (select distinct user_id from diap01.mec_us_united_20056.ual_pathing_gacq)
                    and interaction_time in (select distinct gmacqtime from diap01.mec_us_united_20056.ual_pathing_gacq))
...
select count(distinct user_id) from diap01.mec_us_united_20056.ual_pathing_gacq
