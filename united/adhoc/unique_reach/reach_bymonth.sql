...
--                 t3.site_dcm,
                ...
                t3.campaign_id,
                s1.site_dcm,
--              uncomment to check that site are receiving correct costMethod
--              t3.CostMethod,
                t3.site_id_dcm,
...
--           t001.site_id_dcm,
         ...
         where
             user_id <> '0'
                 and t001.campaign_id in (8964059, 8958859, 11177760, 11224605, 10942240, 11390108, 11152017, 10742878)
