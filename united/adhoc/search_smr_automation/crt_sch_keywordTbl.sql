CREATE procedure dbo.crt_sch_keywordTbl
as
  if OBJECT_ID('master.dbo.sch_keyword',N'U') is not null
    drop table master.dbo.sch_keyword;
  create table dbo.sch_keyword
  (
    paid_search_keyword_id  bigint,
    paid_search_keyword     varchar(1000)
  );

  insert into dbo.sch_keyword
