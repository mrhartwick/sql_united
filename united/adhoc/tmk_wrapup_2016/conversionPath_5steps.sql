...
from (
       ...
       from
         (select
          ...
          from (select
                  t8.user_id,
                  case when t8.path_1 = 1 then 'Retargeting' when t8.path_1 = 2 then 'Prospecting' else 'xxx' end as path_1,
                  case when t8.path_2 = 1 then 'Retargeting' when t8.path_2 = 2 then 'Prospecting' else 'xxx' end as path_2,
                  case when t8.path_3 = 1 then 'Retargeting' when t8.path_3 = 2 then 'Prospecting' else 'xxx' end as path_3,
                  case when t8.path_4 = 1 then 'Retargeting' when t8.path_4 = 2 then 'Prospecting' else 'xxx' end as path_4,
                  case when t8.path_5 = 1 then 'Retargeting' when t8.path_5 = 2 then 'Prospecting' else 'xxx' end as path_5
                                                   ...
                                                   from
                                                     (
                                                       ...
                                                       from (select *
                                                             ...
                                                             where cast(impression_time as date) between '2016-12-01' and '2016-12-10'
...
--                             and site_id = 1578478
                                                   ...
                                                   where t3.user_id in (
                                                     ...
                                                     where
                                                       cast(activity_time as date) between '2016-12-01' and '2016-12-10'
                                                         and advertiser_id <> 0
--  Google
--                        and site_id <> 1578478
                                                         and revenue <> 0
