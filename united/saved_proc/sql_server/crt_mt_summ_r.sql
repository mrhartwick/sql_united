CREATE procedure dbo.crt_mt_summ_r
as
if OBJECT_ID('master.dbo.mt_summ_r',N'U') is not null
  drop table master.dbo.mt_summ_r;


create table master.dbo.mt_summ_r
(
  joinKey                     varchar(255),
...
insert into master.dbo.mt_summ_r
  select distinct
