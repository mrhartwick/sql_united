...
as
if OBJECT_ID('DM_1161_UnitedAirlinesUSA.dbo.ivd_summ_agg',N'U') is not null
    drop table dbo.ivd_summ_agg;
create table dbo.ivd_summ_agg
(
    joinKey                 varchar(255),
    ivDate                  date,
...
insert into dbo.ivd_summ_agg
    ...
    select
        ...
        sum(in_unit_clicks)
    from DM_1161_UnitedAirlinesUSA.dbo.ivd_summ
