...
try:
	datasource1 = datasource0.resolveChoice(
		specs=[('_c0', 'cast:long'), ('_c1', 'cast:string'), ('_c2', 'cast:int'), ('_c3', 'cast:int'),
			   ...
			   ('_c15', 'cast:int'), ('_c16', 'cast:string'), ('_c17', 'cast:string'), ('_c18', 'cast:long'),
			   ('_c19', 'cast:string'), ('_c20', 'cast:string'), ('_c21', 'cast:string'), ('_c22', 'cast:int'),
			   ('_c23', 'cast:int'), ('_c24', 'cast:int'), ('_c25', 'cast:int'), ('_c26', 'cast:int'),
			   ('_c27', 'cast:int'),
			   ('_c28', 'cast:int'), ('_c29', 'cast:int'), ('_c30', 'cast:string'),
			   ('_c31', 'cast:int'), ('_c32', 'cast:string'), ('_c33', 'cast:string'),
			   ('_c34', 'cast:string'), ('_c35', 'cast:int'), ('_c36', 'cast:string'),
			   ('_c37', 'cast:boolean'), ('_c38', 'cast:int'), ('_c39', 'cast:string'),
			   ('_c40', 'cast:int'), ('_c41', 'cast:int'), ('_c42', 'cast:int'),
			   ('_c43', 'cast:int'), ('_c44', 'cast:int'), ('_c45', 'cast:int'),
			   ('_c46', 'cast:int'), ('_c47', 'cast:int'), ('_c48', 'cast:string'),
			   ('_c49', 'cast:int'), ('_c50', 'cast:int'), ('_c51', 'cast:int'),
			   ('_c52', 'cast:int'), ('_c53', 'cast:int'), ('_c54', 'cast:int'),
			   ('_c55', 'cast:int'), ('_c56', 'cast:int'), ('_c57', 'cast:int'),
			   ('_c58', 'cast:int'), ('_c59', 'cast:int'), ('_c60', 'cast:int'),
			   ...
			   ('_c98', 'cast:long'), ('_c99', 'cast:boolean'), ('_c100', 'cast:timestamp'),
			   ('_c101', 'cast:timestamp'), ('_c102', 'cast:int'),
...
applymapping1 = ApplyMapping.apply(frame=datasource1, mappings=[("_c0", "long", "event_time", "long"),
																...
																("_c18", "long", "segment_value_1", "long"),
																("_c19", "string", "event_type", "string"),
																("_c20", "string", "event_sub_type", "string"),
																("_c21", "string", "dbm_auction_id", "string"),
																("_c22", "int", "dbm_request_time", "int"),
																("_c23", "int", "dbm_advertiser_id", "int"),
																("_c24", "int", "dbm_insertion_order_id", "int"),
																("_c25", "int", "dbm_line_item_id", "int"),
																("_c26", "int", "dbm_creative_id", "int"),
																("_c27", "int", "dbm_bid_price_usd", "int"),
																("_c28", "int", "dbm_bid_price_partner_currency", "int"),
																("_c29", "int", "dbm_bid_price_advertiser_currency","int"),
																("_c30", "string", "dbm_url", "string"),
																("_c31", "int", "dbm_site_id", "int"),
																("_c32", "string", "dbm_language", "string"),
																("_c33", "string", "dbm_adx_page_categories", "string"),
																("_c34", "string", "dbm_matching_targeted_keywords","string"),
																("_c35", "int", "dbm_exchange_id", "int"),
																("_c36", "string","dbm_attributed_inventory_source_external_id","string"),
																("_c37", "boolean","dbm_attributed_inventory_source_is_public","boolean"),
																("_c38", "int", "dbm_ad_position", "int"),
																("_c39", "string", "dbm_country_code", "string"),
																("_c40", "int", "dbm_designated_market_area_dma_id","int"),
																("_c41", "int", "dbm_zip_postal_code", "int"),
																("_c42", "int", "dbm_state_region_id", "int"),
																("_c43", "int", "dbm_city_id", "int"),
																("_c44", "int", "dbm_operating_system_id", "int"),
																("_c45", "int", "dbm_browser_platform_id", "int"),
																("_c46", "int", "dbm_browser_timezone_offset_minutes","int"),
																("_c47", "int", "dbm_net_speed", "int"),
																("_c48", "string", "dbm_matching_targeted_segments","string"),
																("_c49", "int", "dbm_isp_id", "int"),
																("_c50", "int", "dbm_device_type", "int"),
																("_c51", "int", "dbm_mobile_make_id", "int"),
																("_c52", "int", "dbm_mobile_model_id", "int"),
																...
																("_c98", "long", "md_user_id_numeric", "long"),
																("_c99", "boolean", "md_user_id_0", "boolean"),
																("_c100", "timestamp", "md_event_time", "timestamp"),
																("_c101", "timestamp", "md_dbm_request_time", "timestamp"),
																("_c102", "int", "md_file_date", "int"),
