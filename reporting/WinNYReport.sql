...
--asset type
  ...
  case when t3.placement  like '%[Mm][Oo][Bb]%' or t3.placement like '%Mobile%' or t3.placement like '%[Ii]pad%' or t3.placement like '%[Tt][Aa][Bb]%'  then 'Mobile'
  when t3.placement  like '%[Dd][Ee][Ss][Kk]%' or t3.placement like '%Desktop%'  then 'Desktop'
        else 'Desktop'  end                                                                            as "Mob/Desk",

  --asset type
  case when t3.placement  like '%[Oo][Oo][Hh]%' or t3.cost_id= 'PF2679' then 'OOH'
        else ''  end                                                                                   as "OOH?",
...
and campaign_id in (10918234) -- display 2017
and (advertiser_id <> 0)
