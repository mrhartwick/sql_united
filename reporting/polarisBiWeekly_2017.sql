...
where cast (timestamp_trunc(to_timestamp(interaction_time / 1000000),''SS'') as date ) between ''2017-01-23'' and ''2017-03-13''
...
where cast (timestamp_trunc(to_timestamp(event_time / 1000000),''SS'') as date ) between ''2017-01-23'' and ''2017-03-13''
and campaign_id in (10768497) -- Polaris 2017
