...
from
    (
        select
            ...
            when t1.rt_2_dest in ('AUS','MEL','MEX','SFO','PVG','SIN','HND','EWR') then t1.rt_2_dest
            when t1.rt_1_dest in ('AUS','MEL','MEX','SFO','PVG','SIN','HND','EWR') then t1.rt_1_dest
            else t1.rt_2_dest
            end                                                                                          as destination,
...
where
t2.route_1_origin LIKE '%LAX%'
AND (
  t2.destination like '%AUS%'
