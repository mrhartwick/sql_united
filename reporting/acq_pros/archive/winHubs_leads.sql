...
--     case
--     when cast(t3.dcmdate as date) between '2017-10-01' and '2017-10-08' then 'week 1'
...
where cast (timestamp_trunc(to_timestamp(event_time / 1000000),''SS'') as date ) between ''2017-10-01'' and ''2017-12-12''
and ((campaign_id = 20377442) or (campaign_id = 10742878 and site_id_dcm = 1190273))
