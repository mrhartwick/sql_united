...
-- regexp_replace(campaign.campaign ,''[\x2C\x22]'', '''', 1, 0, ''ib'') as campaign,
...
-- filter out test placements from Hong Kong campaign appearing in 2017
where t2.placement <> 'test'
