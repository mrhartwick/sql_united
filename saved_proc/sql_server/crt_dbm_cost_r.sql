create procedure dbo.crt_dbm_cost_r
as
if OBJECT_ID('master.dbo.dbm_cost_r',N'U') is not null
  drop table master.dbo.dbm_cost_r;


create table master.dbo.dbm_cost_r
(
...
insert into master.dbo.dbm_cost_r
