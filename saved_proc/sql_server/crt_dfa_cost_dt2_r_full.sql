create procedure dbo.crt_dfa_cost_dt2_r_full
as
if OBJECT_ID('master.dbo.dfa_cost_dt2_r_full',N'U') is not null
    drop table master.dbo.dfa_cost_dt2_r_full;


create table master.dbo.dfa_cost_dt2_r_full
(
  cost_id       nvarchar(6)    ,
...
insert into master.dbo.dfa_cost_dt2_r_full
 select
