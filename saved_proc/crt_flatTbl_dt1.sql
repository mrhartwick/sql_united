alter procedure dbo.createflatTblDT1
as
if  OBJECT_ID('master.dbo.flatTableDT1',N'U') is not null
    drop table master.dbo.flatTableDT1;


create table master.dbo.flatTableDT1
(
...
insert into master.dbo.flatTableDT1
